            ...
            <div class="authorization">
                <div class="authorization_form">
                    <form method="post" action="createAccount">
                        ...
                        <label class="label">本棚のパスワード</label> <input type="password" class="input" id="shelfPassword" name="shelfPassword" required> <label class="label">本棚のパスワード（確認用）</label> <input type="password" class="input" id="shelfPasswordForCheck" name="shelfPasswordForCheck" required>
